...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    user: {
      ...
      resolve(parentValue, args) {
        // resolve function is used to fetch data from db or other source
  ...
  fields: {
    addUser: {
      ...
      resolve(parentValue,{firstName, age}){
        return axios.post('http://localhost:3001/users/', {firstName, age})
          .then(res => res.data)
      }
    },
    deleteUser: {
      ...
      resolve(parentValue, args) {
        return axios.delete(`http://localhost:3001/users/${args.id}`)
          .then(res => res.data)
      }
    },
    updateUser:{
